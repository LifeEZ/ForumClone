...
from hiver_routing import IDENTITY_PREFIXES
...
def test_served_prefixes_are_known_to_gateway() -> None:
    ...
    unknown = served - set(IDENTITY_PREFIXES)
    assert not unknown, (
        f"Identity serves prefixes absent from hiver-routing IDENTITY_PREFIXES: {sorted(unknown)}. "
